...
SET search_path TO sample_data_dev;

SHOW TABLE category;
SHOW TABLE sales;
SHOW TABLE "event";

CREATE TABLE public.tickit_category_redshift (                 
...
CREATE TABLE public.tickit_sales_redshift (                         
...
CREATE TABLE public.tickit_event_redshift (                          
...
INSERT INTO public.tickit_category_redshift SELECT * FROM category LIMIT 1000;
INSERT INTO public.tickit_sales_redshift SELECT * FROM sales LIMIT 1000;
INSERT INTO public.tickit_category_redshift SELECT * FROM category LIMIT 1000;
